module.exports = function (grunt) {
    ...
    grunt.registerTask('build', [
        ...
        'concat:build_css', 'copy:build_app_assets','copy:copy_htaccess', 'copy:build_vendor_assets', 'copy:extra_templates',
    ...
    grunt.registerTask('compile', [
        'less:compile', 'copy:compile_assets', 'copy:extra_templates', 'concat:compile_js', 'uglify', 'index:compile', 'copy:copy_htaccess_bin'
    ]);
