...
the header and footer. It declares with `ngApp` that this is `mbd`,
...
mbd insert 3 views in index.html: 
...
"mbd" will rename the resultant CSS and JavaScript placed in `build/`,
